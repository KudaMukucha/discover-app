...
const SideDrawer = ({ place, close }: any) => {
    ...
    return (
        <div className='h-screen w-screen md:w-[400px] bg-white shadow-md p-5 z-20'>
            ...
            <div>
                <h2 className='line-clamp-2 font-semibold mb-3 text-1xl'>{place.name}</h2>
                ...
                <div className="flex gap-2 mt-3">
                    ...
                    <h2 className='text-[13px] text-gray-600 line-clamp-2'>{place.formatted_address}</h2>
                </div>
                ...
                <div className="flex gap-2 mt-3">
                    ...
                    <h2 className='text-[13px] text-gray-600 line-clamp-2 tracking-wider'>{place.rating} ({place.user_ratings_total})</h2>
